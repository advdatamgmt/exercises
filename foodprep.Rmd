...
This module focuses on several common data manipulation task: selecting, subsetting, concatinating, merging, and sorting.
Some you have already seen before, but this is a good time for review and reinforcement.  For example, when you want 
to select a part of a `vector` use use the square brackets, `[]`, placing between them a numeric vector that lists the elements you
...
```{r}
LETTERS[-26:-21]
# another way to get the even ones:
LETTERS[-seq(1, 26, by = 2)]
```
