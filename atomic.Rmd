...
5. Remember **presidence** from the [Rithmatic](rithmatic.html#presidence) exercise?  Do you need the parentheses above?  Write out the presidence for the **arithmetic operators** (`*`, `/`, `+`, `-`), 
**logical operators** (`!`, `&`, `|`), 
