...
The function is called `ggplot` (note no number 2 on the end).  You
want to store this output in a name because all you are doing below is
telling ggplot how to "think"" about the data, i.e., what represents x
...
functions have often have "aesthetics"" listed, in addition to the usual 
"arguments" that all R functions have, 
that control the way the data is displayed.  Aesthetics are placed
within a function
